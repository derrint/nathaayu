                    ...
                    case "caricustomer": // ========================================================================================================
                        ...
                        <form id="entry-barang" method=POST action='js_jual_barang.php?act=caricustomer&action=tambah'>
                            <div class="input-group">
                                ...
                                <input type="text" name="barcode" accesskey="b" id="barcode" autofocus autocomplete="off">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" min="1" id="jumBarang" name='jumBarang' value='1' size=5 accesskey="q" autocomplete="off">
                            </div>
